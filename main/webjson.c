...
static cJSON *status_to_json()
{
    ...
    /* git */
    cJSON_AddItemToObject(json, "compile_date", cJSON_CreateStringReference(config_get_compile_date()));
    cJSON_AddItemToObject(json, "compile_git", cJSON_CreateStringReference(config_get_version()));

    /* server */
    cJSON_AddItemToObject(json, "server_state", cJSON_CreateStringReference(status.server));
    ...
    cJSON_AddItemToObject(json, "rtp_error", cJSON_CreateNumber(status.rtp_error));
    cJSON_AddItemToObject(json, "rtp_loss", cJSON_CreateNumber(status.rtp_loss));

    /* mjpeg */
    cJSON_AddItemToObject(json, "mjpeg_good", cJSON_CreateNumber(status.mjpeg_good));
    cJSON_AddItemToObject(json, "mjpeg_error", cJSON_CreateNumber(status.mjpeg_error));
    cJSON_AddItemToObject(json, "mjpeg_loss", cJSON_CreateNumber(status.mjpeg_loss));

    /* artnet */
    cJSON_AddItemToObject(json, "artnet_good", cJSON_CreateNumber(status.artnet_good));
    cJSON_AddItemToObject(json, "artnet_error", cJSON_CreateNumber(status.artnet_error));
    cJSON_AddItemToObject(json, "artnet_loss", cJSON_CreateNumber(status.artnet_loss));

    /* led timing */
    cJSON_AddItemToObject(json, "led_on_time", cJSON_CreateNumber(status.led_on_time));
    cJSON_AddItemToObject(json, "led_bottom_too_slow", cJSON_CreateNumber(status.led_bottom_too_slow));
    cJSON_AddItemToObject(json, "led_top_too_slow", cJSON_CreateNumber(status.led_top_too_slow));
    ...
    /* free */
    snprintf(line, sizeof(line), "%d B", heap_caps_get_free_size(MALLOC_CAP_DEFAULT));
    ...
    /* partition */
    cJSON_AddItemToObject(json, "boot_partition", cJSON_CreateStringReference(esp_ota_get_running_partition()->label));
    ...
    /* networking */
    cJSON_AddItemToObject(json, "net_sta", cJSON_CreateStringReference(status.sta));
    cJSON_AddItemToObject(json, "net_ap", cJSON_CreateStringReference(status.ap));
    cJSON_AddItemToObject(json, "net_ethernet", cJSON_CreateStringReference(status.ethernet));
    ...
    /* time */
    cJSON_AddItemToObject(json, "net_ntp", cJSON_CreateStringReference(status.ntp));
    cJSON_AddItemToObject(json, "net_geoip", cJSON_CreateStringReference(status.geoip));
    return json;
}
...
static cJSON *config_to_json()
{
    ...
    /* wifi */
    cJSON_AddItemToObject(json, "wifi_sta_ssid", cJSON_CreateStringReference(config_get_wifi_sta_ssid()));
    cJSON_AddItemToObject(json, "wifi_sta_password", cJSON_CreateStringReference(config_get_wifi_sta_password()));
    cJSON_AddItemToObject(json, "wifi_ap_ssid", cJSON_CreateStringReference(config_get_wifi_ap_ssid()));
    cJSON_AddItemToObject(json, "wifi_ap_password", cJSON_CreateStringReference(config_get_wifi_ap_password()));

    /* rtp */
    cJSON_AddItemToObject(json, "rtp_port", cJSON_CreateNumber(config_get_udp_port()));
    cJSON_AddItemToObject(json, "registration_server", cJSON_CreateStringReference(config_get_udp_server()));

    /* all leds */
    cJSON_AddItemToObject(json, "prefix_leds", cJSON_CreateNumber(config_get_prefix_leds()));
    cJSON_AddItemToObject(json, "channels", cJSON_CreateNumber(ownled_getChannels()));
    cJSON_AddItemToObject(json, "refresh_rate", cJSON_CreateNumber(config_get_refresh_rate()));
    cJSON_AddItemToObject(json, "artnet_width", cJSON_CreateNumber(config_get_artnet_width()));
    cJSON_AddItemToObject(json, "artnet_universe_offset", cJSON_CreateNumber(config_get_artnet_universe_offset()));
    ...
    /* color configs */
    cJSON_AddItemToObject(json, "contrast", cJSON_CreateNumber((int)(led_coloring.contrast * 100 - 100)));
    cJSON_AddItemToObject(json, "brightness", cJSON_CreateNumber((int)(led_coloring.brightness * 100)));
    cJSON_AddItemToObject(json, "red_contrast", cJSON_CreateNumber((int)(led_coloring.red_contrast * 100 - 100)));
    cJSON_AddItemToObject(json, "red_brightness", cJSON_CreateNumber((int)(led_coloring.red_brightness * 100)));
    cJSON_AddItemToObject(json, "green_contrast", cJSON_CreateNumber((int)(led_coloring.green_contrast * 100 - 100)));
    cJSON_AddItemToObject(json, "green_brightness", cJSON_CreateNumber((int)(led_coloring.green_brightness * 100)));
    cJSON_AddItemToObject(json, "blue_contrast", cJSON_CreateNumber((int)(led_coloring.blue_contrast * 100 - 100)));
    cJSON_AddItemToObject(json, "blue_brightness", cJSON_CreateNumber((int)(led_coloring.blue_brightness * 100)));
    cJSON_AddItemToObject(json, "saturation", cJSON_CreateNumber((int)(led_coloring.saturation * 100 - 100)));
    cJSON_AddItemToObject(json, "hue", cJSON_CreateNumber((int)(led_coloring.hue * 100)));

    /* LED config */
    cJSON_AddItemToObject(json, "led_frequency", cJSON_CreateNumber(ownled_get_pulse_frequency()));
    cJSON_AddItemToObject(json, "led_one", cJSON_CreateNumber(ownled_get_pulse_one()));
    cJSON_AddItemToObject(json, "led_zero", cJSON_CreateNumber(ownled_get_pulse_zero()));
    cJSON_AddItemToObject(json, "led_order", cJSON_CreateNumber(ownled_getColorOrder()));
...
static const char *parseConfigNetwork(cJSON *root)
{
    ...
    if (!n || n->type != cJSON_String || strlen(n->valuestring) < 8 || strlen(n->valuestring) > 63)
...
static const char *parseConfigPlaylist(cJSON *root)
{
    ...
    if (!root || root->type != cJSON_Array || cJSON_GetArraySize(root) != playlist_getEntries())
        return "invalid";
    ...
    for (int i = 0; i < playlist_getEntries(); i++)
    {
        ...
        if (!n || n->type != cJSON_Number || n->valueint < 0 || n->valueint > 1000000)
            return "invalid duration";
        entry.duration = n->valueint;
        n = cJSON_GetObjectItem(subitem, "mode");
        if (!n || n->type != cJSON_Number || n->valueint < 0 || n->valueint >= PLAYLIST_LAST)
            return "invalid mode";
...
static const char *parseConfigLed(cJSON *root)
{
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        if (!s || s->type != cJSON_Number || s->valueint < 0 || s->valueint >= LED_MODE_MAXVALUE)
            return "no leds s";
        ...
        if (!r || r->type != cJSON_Number || r->valueint < 0 || r->valueint >= LED_ORI_MAXVALUE)
            return "no leds r";
        ...
        config_set_led_line(i, s->valueint, sx->valueint, sy->valueint,
                            ox->valueint, oy->valueint, r->valueint, op->valuestring);
    }
